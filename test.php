				...
				if($total != 0){
					while($result = mysqli_fetch_assoc($data)){
						echo "<tr>
				 			...
				 			<td><a href='update.php?cID=$result[cID]&cName=$result[cName]&arrestDate=$result[arrestDate]&birthdate=$result[birthdate]&nID=$result[nID]&caseID=$result[caseID]&lawyerName=$result[lawyerName]&Gender=$result[Gender]&BloodType=$result[BloodType] '>Edit</a><br><br><a href='#'>Delete</a></td>
				 			</tr>";
					}
				}
				else{
